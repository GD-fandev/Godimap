...
> **使用上の注意：** Godiusでは、F11が標準でヘルプを呼び出すキーに設定されています。GODIMAPを使用する前に、ゲーム内オプションでヘルプ呼び出しキーをF11からHなど別のキーへ変更してください。
...
<kbd>Ctrl</kbd> + <kbd>F11</kbd> で編集モードを開始・終了します。
...
> **사용 시 주의사항:** 가디우스 내에서 F11은 도움말을 호출하는 키입니다. 본 툴을 사용하기 전에 게임 내 옵션에서 도움말 호출 키를 F11에서 H 등 다른 키로 변경한 뒤 사용하십시오.
...
<kbd>Ctrl</kbd> + <kbd>F11</kbd>로 편집 모드를 켜거나 끕니다.
...
> **Important:** F11 opens Help by default in Godius. Before using GODIMAP, open the in-game options and change the Help key from F11 to another key such as H.
...
Press <kbd>Ctrl</kbd> + <kbd>F11</kbd> to enter or leave edit mode.
